  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <hr style="padding:30px;" class="section">
    ...
    <div class="row">
      <div class="col-sm-6 portfolio-item"> <a href="work-details.html" class="portfolio-link">
        <div class="caption">
          <div class="caption-content">
            <h3><b> Birthday Cards/Anniversary card/NewBaby born card/New Home card /Valentines Day card</h3>
            <h4>Make every occasion special with us</b></h4>
          </div>
        </div>
      ...
      <div class="col-sm-6 portfolio-item"> <a href="work-details.html" class="portfolio-link">
        <div class="caption">
          <div class="caption-content">
            <h3><b> Canvas Painting/Hand Painted Abstracts/</b> </h3>
			<h3><b> Decorative Paintings For Wall/Landscape/</b></h3>
			<h3><b> Seascape/Personalized skechting</b></h3>
      ...
      <div class="col-sm-6 portfolio-item"> <a href="work-details.html" class="portfolio-link">
        <div class="caption">
          <div class="caption-content">
            <h3><b>Face Soap/Bath Soap/Facial Soap/Foot Soap/</b></h3>
			<h3><b>Scrub/Comboes/Hampers</b></h3>
            <h4><b>We Take Best Care Of Your Body</b></h4>
          </div>
        </div>
      ...
      <div class="col-sm-6 portfolio-item"> <a href="work-details.html" class="portfolio-link">
        <div class="caption">
          <div class="caption-content">
           <h3><b>Mug Printing/Customized Key Rings</b></h3>
		    <h3><b>Cusion Printing/T-Shirt Printing/Customized Mobile Covers</b></h3>
      ...
      <div class="col-sm-6 portfolio-item"> <a href="work-details.html" class="portfolio-link">
        <div class="caption">
          <div class="caption-content">
             <h3><b>Embrace The Flower Power/</b></h3>
			  <h3><b>Trays/Envelops/Coin Packing</b></h3>
            <h4><b>Make Us Part Of Your Special Day</b></h4>
          </div>
        </div>
      ...
      <div class="col-sm-6 portfolio-item"> <a href="work-details.html" class="portfolio-link">
        <div class="caption">
          <div class="caption-content">
            <h3><b>Theme Party Props/Theme Party Games</b></h3>
			<h3><b>Return Gifts/Selfie Booth</b></h3>
	...
	<div class="col-sm-6 portfolio-item"> <a href="work-details.html" class="portfolio-link">
        <div class="caption">
          <div class="caption-content">
           <h3><b>Baby Album/Birthday Album</b></h3>
              <h3><b>Anniversary Album/Customized Album</b></h3>
          </div>
        </div>
